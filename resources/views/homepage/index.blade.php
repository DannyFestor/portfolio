<x-app-layout>
    ...
    <x-slot:main_classes>flex flex-col items-center justify-center</x-slot:main_classes>
        ...
        <article
            ...
            <p class="icons flex gap-2 justify-between">
                ...
                <a href="https://vuejs.org/" class="w-1/5 flex justify-center items-center">
                    <img class="w-[100%] max-w-12" src="{{ asset('icons/vuejs.svg') }}" alt="Vue.js" aria-label="Vue.js"
                         title="Vue.js">
                </a>
            ...
            <p id="cv" class="mt-8 flex flex-wrap">
                ...
                <span class="flex gap-4 items-center ml-auto">
                    <a href="{{ asset('cv/[GER]-2022-12-15.pdf') }}">
                        <img class="h-8 w-8" src="{{ asset('flags/de.svg') }}" alt="German CV" aria-label="German CV" title="German CV">
                    </a>
                    <a href="{{ asset('cv/[ENG]-2022-12-15.pdf') }}">
                        <img class="h-8 w-8" src="{{ asset('flags/us.svg') }}" alt="English CV" aria-label="English CV" title="English CV">
                    </a>
                    <a href="{{ asset('cv/[JAP]-2022-12-15.pdf') }}">
                        <img class="h-8 w-8" src="{{ asset('flags/jp.svg') }}" alt="Japanese CV" aria-label="German CV" title="German CV">
                    </a>
                </span>
            </p>
        </article>
